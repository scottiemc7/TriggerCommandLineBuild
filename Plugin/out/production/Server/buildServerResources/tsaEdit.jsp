...
<tr>
    <th>
        <label for="tsa.forge">Forge path: </label>
    </th>
    <td>
        <props:textProperty name="tsa.forge" size="75" />
        <span class="error" id="error_tsa.forge"></span>
        <span class="smallNote">The path to the directory containing <b>forge.exe</b>.</span>
    </td>
</tr>

<tr>
    <th>
        <label for="tsa.src">App path: </label> <l:star/>
    </th>
    <td>
        <props:textProperty name="tsa.src" size="75" />
        <span class="error" id="error_tsa.src"></span>
        <span class="smallNote">The path to your app folder, relative to the checkout directory. The <b>local_config.json</b> file should be at the root of this folder.</span>
    </td>
</tr>
...
<tr>
    <th>
        <label>Sanity Check: </label> <l:star/>
    </th>
    <td>
        <label for="tsa.platform.ios"><props:checkboxProperty name="tsa.check" />Perform</label>
        <span class="error" id="error_tsa.check"></span>
        <span class="smallNote">Perform sanity check before build.</span>
    </td>
</tr>

<tr>
    <th>
        <label for="tsa.andsdk">Android SDK path: </label> <l:star/>
    </th>
    <td>
        <props:textProperty name="tsa.andsdk" size="75" />
        <span class="error" id="error_tsa.andsdk"></span>
        <span class="smallNote">The path to the Android SDK folder.</span>
    </td>
</tr>
